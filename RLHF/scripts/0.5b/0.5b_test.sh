...
LM_MODEL_NAME=llava-onevision-qwen2-0.5b-ov/

# DATA CONFIG
#PREFERENCE_DATA=output_discretized.json
PREFERENCE_DATA=k_means_qwen.json

# SAVE CONFIG
MODEL_NAME=LLaVA-Fact-RM-7B-v1.5-336-lora-batch20-nopadding-discretized_actions-nosubgoal-10k
